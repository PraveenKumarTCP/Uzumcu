...
export default function Footer() {
    return (
        <footer className="bg-white pt-24 pb-12 overflow-hidden" data-aos="fade-up">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24 items-start mb-20 leading-relaxed text-[#111827]">
                    ...
                    <div className="lg:col-span-1">
                        <img src="/images/uzumcu-logo.png" alt="UZUMCU" className="h-10 mb-8" />
                    ...
                    <div className="flex flex-col gap-4 lg:items-end">
                        ...
                        <div className="text-[9px] font-bold flex flex-col items-end gap-3 opacity-90">
                ...
                <div className="pt-8 border-t border-gray-600 flex flex-col md:flex-row justify-between items-center text-[8px] font-black ">
                    <p>2026 ÜZÜMCÜ</p>
                    <p className="tracking-[0.5em] inline-flex items-center text-primary">bilok</p>
                </div>
            </div>
        </footer>
    );
